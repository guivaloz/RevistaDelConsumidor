...
<?php
/**
 * Gutenberg - ProcesarPublicaciones
 *
...
function ayuda() {
    echo "\n";
    echo "Objetivo:\n";
    echo "  PROCESAR cada registro de Publicación en la base de datos para clasificarla.\n";
    echo "\n";
    echo "Sintaxis:\n";
...
// Proceso principal
echo "$soy Inicia.\n";
$procesador = new \GutProcesadores\Procesar($sesion);
try {
    echo $procesador->alimentar()."\n";
} catch (\Exception $e) {
